...
func TestEtcdInspectionController_Comprehensive(t *testing.T) {
	t.Run("NewEtcdInspectionController with valid config", func(t *testing.T) {
		config := &Config{
		...
		controller := NewEtcdInspectionController(config, logger)
		assert.NotNil(t, controller)
		assert.NotNil(t, controller.config)
		assert.NotNil(t, controller.logger)
	})

	t.Run("NewEtcdInspectionController with nil config", func(t *testing.T) {
		logger, _ := zap.NewDevelopment()

		controller := NewEtcdInspectionController(nil, logger)
		assert.NotNil(t, controller)
	...
	t.Run("NewEtcdInspectionController with nil logger", func(t *testing.T) {
		...
		controller := NewEtcdInspectionController(config, nil)
		assert.NotNil(t, controller)
		assert.NotNil(t, controller.config)
		assert.NotNil(t, controller.logger) // Should create a production logger
	})

	t.Run("NewEtcdInspectionController with empty config", func(t *testing.T) {
		config := &Config{}
		logger, _ := zap.NewDevelopment()
