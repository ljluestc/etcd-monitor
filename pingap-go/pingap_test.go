...
func TestPingap_RunProxy(t *testing.T) {
	logger, _ := zap.NewDevelopment()
	...
	t.Run("RunProxy - Success", func(t *testing.T) {
		...
		pingap := NewPingap(logger)
		result, err := pingap.RunProxy(context.Background(), mockTarget)
	...
	t.Run("RunProxy - Nil Target", func(t *testing.T) {
		pingap := NewPingap(logger)
		result, err := pingap.RunProxy(context.Background(), nil)
...
func TestPingap_RunLoadBalancer(t *testing.T) {
	logger, _ := zap.NewDevelopment()
	...
	t.Run("RunLoadBalancer - Success", func(t *testing.T) {
		...
		pingap := NewPingap(logger)
		result, err := pingap.RunLoadBalancer(context.Background(), mockTarget)
	...
	t.Run("RunLoadBalancer - Nil Target", func(t *testing.T) {
		pingap := NewPingap(logger)
		result, err := pingap.RunLoadBalancer(context.Background(), nil)
...
func TestPingap_RunHealthCheck(t *testing.T) {
	logger, _ := zap.NewDevelopment()
	...
	t.Run("RunHealthCheck - Success", func(t *testing.T) {
		...
		pingap := NewPingap(logger)
		result, err := pingap.RunHealthCheck(context.Background(), mockTarget)
	...
	t.Run("RunHealthCheck - Nil Target", func(t *testing.T) {
		pingap := NewPingap(logger)
		result, err := pingap.RunHealthCheck(context.Background(), nil)
	...
	t.Run("Concurrent Operations", func(t *testing.T) {
		...
		for i := 0; i < 20; i++ {
			go func() {
				...
				proxyResult, err := pingap.RunProxy(context.Background(), mockTarget)
				if err == nil {
					assert.Equal(t, "concurrent pingap result", proxyResult)
				}
				
				loadBalancerResult, err := pingap.RunLoadBalancer(context.Background(), mockTarget)
				if err == nil {
					assert.Equal(t, "concurrent pingap result", loadBalancerResult)
				}
				
				healthCheckResult, err := pingap.RunHealthCheck(context.Background(), mockTarget)
				if err == nil {
					assert.Equal(t, "concurrent pingap result", healthCheckResult)
				}
			}()
		}
...
func TestPingap_Integration(t *testing.T) {
	...
	t.Run("Full Pingap Flow", func(t *testing.T) {
		...
		proxyResult, err := pingap.RunProxy(context.Background(), mockTarget)
		require.NoError(t, err)
		assert.Equal(t, "integration test result", proxyResult)
